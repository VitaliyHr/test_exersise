...
const { loginvalidator, registervalidator, ParamsValidator } = require('../middlewares/validator');
...
//скинути пароль
router.post('/reset/:id', auth, ParamsValidator, check_validator, Ctrl.reset_controller);
